...
public class Jk104 {
    ...
    public Jk104() {
        ...
        SaveFunc.setOut(out_);
        SaveFunc.cfg_host = jkp.cfg_host;
        SaveFunc.cfg_insidePort = jkp.cfg_insidePort;
        SaveFunc.CHANNEL = jkp.cfg_ca;
        SaveFunc.IsCreateRtdb = jkp.IsCreateRtdb;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        JkOut.Instance().SetLogDir(CurPath + "/log4j.properties");
...
//            }
            ...
            Instance.out_.AppendError(ex.getMessage());
        }
    }
